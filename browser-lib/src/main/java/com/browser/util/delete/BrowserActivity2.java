...
//
//
//public class BrowserActivity2 extends BaseToolbarActivity {
//
...
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                        BrowserSdk.showToast(BrowserActivity2.this, e.getMessage());
//                    }
//                    return true;
//                }
...
//                    BrowserSdk.openIntentUrl(BrowserActivity2.this, url);
//                    view.stopLoading();
//                    progressBar.setVisibility(View.GONE);
//                    return true;
//                }
//                if (isUrlFacebookType(url) || isUrlTwitterType(url)) {
//                    BrowserSdk.openUrlExternal(BrowserActivity2.this, url);
//                    view.stopLoading();
//                    return true;
//                }
//                view.loadUrl(url);
...
//        CropImage.startPickImageActivity(BrowserActivity2.this);
//    }
//
//
